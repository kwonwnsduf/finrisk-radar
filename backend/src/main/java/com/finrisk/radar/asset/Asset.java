...
@Table(name = "assets", uniqueConstraints =
		@UniqueConstraint(name = "uk_assets_ticker_market", columnNames = {"ticker", "market"}))
public class Asset extends BaseTimeEntity {
	...
	private Asset(String name, String ticker, String market, String sector,
			String country, String currency, AssetType assetType) {
		apply(name, ticker, market, sector, country, currency, assetType);
	}

	public static Asset create(String name, String ticker, String market, String sector,
			String country, String currency, AssetType assetType) {
		return new Asset(name, ticker, market, sector, country, currency, assetType);
	}

	public void canonicalize(String name, String market, String sector,
			String country, String currency, AssetType assetType) {
		apply(name, ticker, market, sector, country, currency, assetType);
	}

	private void apply(String name, String ticker, String market, String sector,
			String country, String currency, AssetType assetType) {
		this.name = name.trim();
