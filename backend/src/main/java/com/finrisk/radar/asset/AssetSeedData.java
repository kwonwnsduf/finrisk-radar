...
public class AssetSeedData implements CommandLineRunner {
	...
	public void run(String... args) {
		for (Seed seed : seeds()) {
			...
			assetRepository.findByTickerAndMarket(seed.ticker(), LEGACY_MARKET)
					.ifPresentOrElse(
							legacy -> legacy.canonicalize(seed.name(), seed.market(), seed.sector(),
									seed.country(), seed.currency(), seed.assetType()),
	...
	private record Seed(String name, String ticker, String market, String sector,
