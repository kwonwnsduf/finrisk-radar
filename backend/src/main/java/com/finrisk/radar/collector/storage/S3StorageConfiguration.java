...
public class S3StorageConfiguration {
	@Bean
	RawMarketDataStorage rawMarketDataStorage(S3Properties properties, ObjectMapper mapper) {
		if (!properties.configured()) return new UnavailableRawMarketDataStorage();
