...
public class FinancialDataFetchConsumer {
  ...
  public FinancialDataFetchConsumer(
      FinancialDataCollectionService collections,
  ...
  @KafkaListener(
      topics = FinancialDataTopics.FETCH_REQUESTED,
      groupId = "finrisk-financial-data-collector")
