...
@Entity
@Table(
    name = "debt_maturities",
    uniqueConstraints =
        @UniqueConstraint(
            name = "uk_debt_maturities_sample",
            columnNames = {"asset_id", "maturity_date", "amount", "debt_type"}))
public class DebtMaturity extends BaseTimeEntity {
  ...
  @Column(name = "external_debt_key", length = 200)
  private String externalDebtKey;

  protected DebtMaturity() {}

  private DebtMaturity(
      Asset asset,
  ...
  public static DebtMaturity create(
      Asset asset,
      LocalDate maturityDate,
      BigDecimal amount,
      DebtType debtType,
    ...
    maturity.snapshotDate = LocalDate.now();
    return maturity;
  }
  ...
  public String getExternalDebtKey() {
    return externalDebtKey;
  }
}
