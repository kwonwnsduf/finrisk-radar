...
@Table(
    ...
    uniqueConstraints =
        @UniqueConstraint(
            name = "uk_financial_metrics_asset_period",
            columnNames = {"asset_id", "year", "quarter"}))
public class FinancialMetric extends BaseTimeEntity {
  ...
  @Column(name = "flow_basis", nullable = false, length = 20)
  private FinancialFlowBasis flowBasis = FinancialFlowBasis.UNKNOWN;
  ...
  public FinancialFlowBasis getFlowBasis() {
    return flowBasis;
  }
